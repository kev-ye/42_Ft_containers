...
// 	cout << "size aft assig: " << vec.size() << endl;
...
int main(void) {
	...
	// std::vector<test>::iterator ite = vec.end();

	// std::vector<test> vec2(it, ite);

	// std::vector<test>::iterator it2 = vec2.begin();
	// std::vector<test>::iterator ite2 = vec2.end();

	// cout << "distance: " << std::distance(it2, ite2) << endl;

	using namespace std;

	std::vector<int> vec((unsigned int)10, (unsigned int)1);

	std::vector<int>::iterator it = vec.begin();
	std::vector<int>::iterator ite = vec.end();

	std::vector<int> vec2(it, ite);

	std::vector<int>::iterator it2 = vec2.begin();
	std::vector<int>::iterator ite2 = vec2.end();
